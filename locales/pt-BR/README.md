...
## 🎉 Roo Code 3.9.4 Lançado

O Roo Code 3.9.4 traz uma nova integração com o Perplexity PRO, permitindo acesso ao modelo Claude 3.7 sem custos adicionais de API:
...
- Todas as funcionalidades da versão 3.9 continuam disponíveis:
  - Suporte para 14 idiomas diferentes (altere em Configurações → Idioma)
...
|<a href="https://github.com/refactorthis"><img src="https://avatars.githubusercontent.com/u/3012240?v=4" width="100" height="100" alt="refactorth
